...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A modern, responsive wedding invitation website with RSVP management and an admin panel." },
      { property: "og:description", content: "A modern, responsive wedding invitation website with RSVP management and an admin panel." },
      { name: "twitter:description", content: "A modern, responsive wedding invitation website with RSVP management and an admin panel." },
